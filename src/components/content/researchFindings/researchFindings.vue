  ...
  <div class="dynamicsBox">
    ...
    <div class="dynamics">
      <div class="institutionalPersonnelCon">
        <div class="centreConTitle"><span>研究</span>成果</div>
      </div>
      <!--      内容-->
      <div class="tabsBox">
        <!--        左边-->
        <div class="tabsBoxLeft">
          <p @click="active('1')" :class="activeName=='1'?'fontColors':''">
            <router-link to="/researchFindings/index">
              <span class="spot"><span v-if="activeName=='1'">●</span></span>&nbsp;学术论文
            </router-link>
          </p>

          <p @click="active('2')" :class="activeName=='2'?'fontColors':''">
            <router-link to="/researchFindings/index">
              <span class="spot"><span v-if="activeName=='2'">●</span></span>&nbsp;学术著作
            </router-link>
          </p>
          <p @click="active('3')" :class="activeName=='3'?'fontColors':''">
            <router-link to="/researchFindings/index">
              <span class="spot"><span v-if="activeName=='3'">●</span></span>&nbsp;科研项目
            </router-link>
          </p>
          <p @click="active('4')" :class="activeName=='4'?'fontColors':''">
            <router-link to="/researchFindings/index">
              <span class="spot"><span v-if="activeName=='4'">●</span></span>&nbsp;咨询报告
            </router-link>
          </p>
        </div>
        <!--        右边-->
