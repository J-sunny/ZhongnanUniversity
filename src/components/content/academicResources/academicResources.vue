<template>
  <div class="dynamicsBox">
    <!--     banner-->
    <div class="bannerBox">
      <img class="bannerPic" src="../../../../static/images/7.png" alt="">
    </div>
    <!--    学术资源-->
    <div class="dynamics">
      <div class="institutionalPersonnelCon">
        <div class="centreConTitle"><span>学术</span>资源</div>
      </div>
      <!--      内容-->
      <div class="tabsBox">
        <!--        左边-->
        <div class="tabsBoxLeft">
          <p @click="active('1')" :class="activeName=='1'?'fontColors':''">
            <router-link to="/academicResources/index">
              <span class="spot"><span v-if="activeName=='1'">●</span></span>&nbsp;行业准则
            </router-link>
          </p>

          <p @click="active('2')" :class="activeName=='2'?'fontColors':''">
            <router-link to="/academicResources/index">
              <span class="spot"><span v-if="activeName=='2'">●</span></span>&nbsp;经典著作
            </router-link>
          </p>
          <p @click="active('3')" :class="activeName=='3'?'fontColors':''">
            <router-link to="/academicResources/index">
              <span class="spot"><span v-if="activeName=='3'">●</span></span>&nbsp;权威文献
            </router-link>
          </p>
          <p @click="active('4')" :class="activeName=='4'?'fontColors':''">
            <router-link to="/academicResources/index">
              <span class="spot"><span v-if="activeName=='4'">●</span></span>&nbsp;特色数据
            </router-link>
          </p>
        </div>
        <!--        右边-->
