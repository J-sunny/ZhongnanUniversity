<template>
  <div class="dynamicsBox">
    <!--     banner-->
    <div class="bannerBox">
      <img class="bannerPic" src="../../../../static/images/8.png" alt="">
    </div>
    <!--    法律法规-->
    <div class="dynamics">
      <div class="institutionalPersonnelCon">
        <div class="centreConTitle"><span>法律</span>法规</div>
      </div>
      <!--      内容-->
      <div class="tabsBox">
        <!--        左边-->
        <div class="tabsBoxLeft">
          <p @click="active('1')" :class="activeName=='1'?'fontColors':''">
            <router-link to="/lawsRegulations/index">
              <span class="spot"><span v-if="activeName=='1'">●</span></span>&nbsp;国家法律
            </router-link>
          </p>

          <p @click="active('2')" :class="activeName=='2'?'fontColors':''">
            <router-link to="/lawsRegulations/index">
              <span class="spot"><span v-if="activeName=='2'">●</span></span>&nbsp;部门规章
            </router-link>
          </p>
          <p @click="active('3')" :class="activeName=='3'?'fontColors':''">
            <router-link to="/lawsRegulations/index">
              <span class="spot"><span v-if="activeName=='3'">●</span></span>&nbsp;行业条文
            </router-link>
          </p>
        </div>
        <!--        右边-->
